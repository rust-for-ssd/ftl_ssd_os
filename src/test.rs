...
use crate::{
    ...
    safe_bindings::{ssd_os_get_connection, ssd_os_mem_get, ssd_os_sleep, ssd_os_this_cpu},
};
...
make_connector_static!(conn_1, init_1, exit, conn_fn_1, ring_1);
make_connector_static!(conn_2, init_2, exit, conn_fn_2, ring_2);
...
fn init_2() -> ::core::ffi::c_int {
    println_s!(c"INIT_2");
    let cpu_id = ssd_os_this_cpu(c"conn_1");
