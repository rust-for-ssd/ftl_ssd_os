...
#define VOLT_CHIP_COUNT      2
#define VOLT_VIRTUAL_LUNS    2
#define VOLT_BLOCK_COUNT     16
...
struct volt_info {
    struct nvm_channel *channel_array;
    uint32_t 		n_channels;
};

/* Extended ssd_os functions */
int volt_get_ch_info (struct volt_info *ch_info);
int volt_get_geometry (struct nvm_mmgr_geometry *g);
int volt_get_last_address (void *ptr);
